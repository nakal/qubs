...
int
hash_put(hash_t *hash, const char *key, void *val, size_t valsize)
{
...
static void
hash_destroylist(hash_element_list_t *elem)
{
...
int
hash_appendtolist(hash_element_list_t **list, hash_element_list_t *elem)
{
...
void *
hash_getlistelement(hash_element_list_t *list, const char *key)
{
...
static size_t
hashsum(const hash_t *hash, const char *key)
{
	size_t k;
	size_t len, i;
...
void
hash_dumplist(hash_element_list_t *elem)
{
