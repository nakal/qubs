...
#define mem_calloc(x,y) memory_calloc((x),(y), __FILE__, __LINE__)
#define mem_realloc(p,x) memory_realloc((p),(x), __FILE__, __LINE__)
...
extern void *memory_calloc(size_t nelem, size_t size, const char *srcname, int line);
