...
void *memory_malloc(size_t size, const char *srcname, int line) {
...
void *memory_calloc(size_t nelem, size_t size, const char *srcname, int line) {
...
void *memory_realloc(void *ptr, size_t size, const char *srcname, int line) {
...
void memory_free(void *ptr, const char *srcname, int line) {
...
void memory_list_allocated(void) {
...
static memory_alloc_history_entry_t memory_remove_entry(void *ptr,
    ...
    memcpy(&cp, memory_alloc_history+i, sizeof(memory_alloc_history_entry_t));
...
void memory_hexdump(void *ptr, const char *srcname, int srcline) {
...
void memory_hexdump_alien(void *ptr, size_t len) {
...
void *compat_calloc(size_t nelem, size_t size) {
...
void *compat_realloc(void *ptr, size_t size) {
